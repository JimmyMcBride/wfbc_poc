...
<section class="relative min-h-[52vh] md:min-h-[58vh] flex items-end justify-center overflow-hidden">
	<div class="absolute inset-0 bg-cover bg-center" style="background-image: url('https://fbcwimberley.com/wp-content/uploads/2025/07/102A5443-scaled.jpg')"></div>
...
<section class="relative py-24 md:py-28 overflow-hidden">
	<div class="absolute inset-0 bg-cover bg-center bg-fixed" style="background-image: url('https://fbcwimberley.com/wp-content/uploads/2024/01/102A6400-1-scaled.jpg')">
